                            ...
                            <div class="card user-card user-card-1">
                                ...
                                <div class="card-body hover-data text-white">
                                    <div class="">
                                        ...
                                        @if ($demande->decision === null)
                                            <a href="{{ route('demande.show', ['id'=>$demande->idDemande]) }}" role="button">
                                                <button type="submit" class="btn waves-effect waves-light btn-secondary"><i class="feather icon-edit"></i>&nbsp;Editer</button>
                                            </a>
