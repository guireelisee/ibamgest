                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Rejet d'une audience</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <form action="{{route('demande.rejetter')}}" method="POST">
                                @csrf
                                <input type="hidden" value="{{$demande[0]->idDemande}}" name="idDemande">
                                <div class="container" style="text-align: center">
                                    <p style="font-size: 17px">Confirmez-vous le rejet de la demande d'audience ?</p>
