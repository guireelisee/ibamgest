                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Enregistrement d'une salle</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="place" class="form-control" id="place" min="0">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="caracteristique">Caractéristiques <span class="text-muted">(facultatif)</span> </label>
                                        <input type="text" name="caracteristique" class="form-control" id="caracteristique">
                                    </div>
                                </div>
                            </div>
