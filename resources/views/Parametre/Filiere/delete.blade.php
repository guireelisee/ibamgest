                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('demande.index') }}">Filières</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('demande.index') }}">Liste des filières</a></li>
                            <li class="breadcrumb-item"><a href="#">suppression d'une filière</a></li>
